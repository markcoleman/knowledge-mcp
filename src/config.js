...
module.exports = {
  ...
  articleBodyField: process.env.SALESFORCE_ARTICLE_BODY_FIELD || 'ArticleBody',
  articleAdditionalFields: process.env.SALESFORCE_ARTICLE_ADDITIONAL_FIELDS || '',
  articleSelectAllFields: (process.env.SALESFORCE_ARTICLE_SELECT_ALL_FIELDS || '').toLowerCase() === 'true',
